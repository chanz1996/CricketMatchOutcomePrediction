...
with open('pvp3.csv') as csvfile:
        ...
        for row in reader:
                ...
                if '0' in row[15]:
                    ipl[row[0]][0] = ipl[row[0]][0] + int(row[8])
                if '1' in row[15]:
                    ipl[row[0]][1] = ipl[row[0]][1] + int(row[8])
                if '2' in row[15]:
                    ipl[row[0]][2] = ipl[row[0]][2] + int(row[8])
                if '3' in row[15]:
                    ipl[row[0]][3] = ipl[row[0]][3] + int(row[8])
                if '4' in row[15]:
                    ipl[row[0]][4] = ipl[row[0]][4] + int(row[8])
